    ...
    return (
       ...
       <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" styles="background: #103cbe;">
           <div class="featured-image mb-3">
            <img src={image2} class="img-fluid rounded-5" styles="width: 250px;" />
           </div>
           <p class="text-black fs-2" styles="font-family: 'Courier New', Courier, monospace; font-weight: 600;">Be Verified</p>
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <div class="input-group mb-3">
                    <button class="btn btn-lg btn-primary w-100 fs-6" onClick={(e)=>registerAction(e)}>Sign Up</button>
                </div>
                <div class="row">
